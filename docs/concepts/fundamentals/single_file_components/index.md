...
url: https://jurooravec.github.io/django-components/docs/concepts/fundamentals/single_file_components/
description: "Components can be defined in a single file, inlining the HTML, JS and CSS within the Python code."
---
...
and [`css_file`][Component.css_file].
