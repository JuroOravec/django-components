...
url: https://jurooravec.github.io/django-components/docs/concepts/fundamentals/component_defaults/
description: "When a component is being rendered, the component inputs are passed to various methods like
get_template_data(),
get_js_data(),
or get_css_data()."
---
...
To define defaults for a component, you create a nested [`Defaults`][Component.Defaults]
class within your [`Component`][Component] class.
...
In this example, `position` is a simple default value, while `selected_items` uses a factory function wrapped in [`Default`][Default] to ensure a new list is created each time the default is used.
...
To avoid this, you can use a factory function wrapped in [`Default`][Default].
...
The defaults may be defined on both [`Component.Defaults`][Component.Defaults] and [`Component.Kwargs`][Component.Kwargs] classes.

To get a final, merged dictionary of all the component's defaults, use [`get_component_defaults()`][get_component_defaults]:
