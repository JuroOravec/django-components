...
url: https://jurooravec.github.io/django-components/docs/concepts/fundamentals/subclassing_components/
description: "In larger projects, you might need to write multiple components with similar behavior.
In such cases, you can extract shared behavior into a standalone..."
---
