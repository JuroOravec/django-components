...
url: https://jurooravec.github.io/django-components/docs/concepts/fundamentals/template_tag_syntax/
description: "All template tags in django_component, like {% component %} or {% slot %}, and so on,
support extra syntax that makes it possible to write components..."
---
...
To disable this behavior, set [`COMPONENTS.multiline_tags`][ComponentsSettings.multiline_tags] to `False`