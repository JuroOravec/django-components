...
url: https://jurooravec.github.io/django-components/docs/concepts/advanced/html_fragments/
description: "Django-components provides a seamless integration with HTML fragments with AJAX (HTML over the wire),
whether you're using jQuery, HTMX, AlpineJS,..."
---
