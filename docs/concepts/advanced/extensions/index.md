---
title: Extensions
url: https://jurooravec.github.io/django-components/docs/concepts/advanced/extensions/
description: "Django-components functionality can be extended with \"extensions\". Extensions allow for powerful customization and integrations. They can:"
---
...
The [Components as Views](../fundamentals/component_views_urls.md) feature is actually implemented as an extension
...
- The extension may implement any of the [hook methods](../../reference/extension_hooks.md).
