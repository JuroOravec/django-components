...
url: https://jurooravec.github.io/django-components/docs/concepts/advanced/component_context_scope/
description: "By default, context variables are passed down the template as in regular Django - deeper scopes can access the variables from the outer scopes. So if..."
---
...
components. This can be configured in [context_behavior][ComponentsSettings.context_behavior].
...
- `"django"`
    ...
    - Data returned from [`Component.get_template_data()`][Component.get_template_data]
...
Then if [`get_template_data()`][Component.get_template_data]
