...
url: https://jurooravec.github.io/django-components/docs/concepts/advanced/tag_formatters/
description: "By default, components are rendered using the pair of {% component %} / {% endcomponent %} template tags:"
---
...
You can change this behaviour in the settings under the [`COMPONENTS.tag_formatter`][ComponentsSettings.tag_formatter].
