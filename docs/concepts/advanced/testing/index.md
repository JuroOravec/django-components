---
title: Testing
url: https://jurooravec.github.io/django-components/docs/concepts/advanced/testing/
description: "The @djc_test decorator is a powerful tool for testing components created with django-components. It ensures that each test is properly isolated,..."
---

_New in version 0.131_

The [`@djc_test`][djc_test] decorator is a powerful tool for testing components created with `django-components`. It ensures that each test is properly isolated, preventing components registered in one test from affecting others.

## Usage

The [`@djc_test`][djc_test] decorator can be applied to functions, methods, or classes.
...
To apply [`@djc_test`][djc_test] to a function,
...
See the API reference for [`@djc_test`][djc_test] for more details.
...
You can parametrize the [context behavior][ComponentsSettings.context_behavior] using [`djc_test`][djc_test]:
