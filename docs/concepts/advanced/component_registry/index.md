...
url: https://jurooravec.github.io/django-components/docs/concepts/advanced/component_registry/
description: "In previous examples you could repeatedly see us using @register() to \"register\"
the components. In this section we dive deeper into what it actually..."
---
