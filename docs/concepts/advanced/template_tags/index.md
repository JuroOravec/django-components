...
url: https://jurooravec.github.io/django-components/docs/concepts/advanced/template_tags/
description: "Template tags introduced by django-components, such as {% component %} and {% slot %},
