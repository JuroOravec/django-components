...
url: https://jurooravec.github.io/django-components/docs/guides/setup/development_server/
description: "When you edit a component's HTML template, JS, or CSS file while the dev server
is running, django_components automatically picks up the change on the..."
---
