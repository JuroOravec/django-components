---
title: Caching
url: https://jurooravec.github.io/django-components/docs/guides/setup/caching/
description: "This page describes the kinds of assets that django-components caches and how to configure the cache backends."
---
