...
url: https://jurooravec.github.io/django-components/docs/getting_started/components_in_templates/
description: "By the end of this section, we want to be able to use our components in Django templates like so:"
---
...
First, however, we need to register our component class with [`ComponentRegistry`][ComponentRegistry].

To register a component with a [`ComponentRegistry`][ComponentRegistry],
we will use the [`@register`][register]
...
!!! info
    ...
    **Why do we have to register components?**
    ...
    [`ComponentRegistry`][ComponentRegistry] acts like a router
...
!!! note
    ...
    You can create custom [`ComponentRegistry`][ComponentRegistry]
...
!!! info
    ...
    **How does django-components pick up registered components?**
    ...
    Notice that it was enough to add [`@register`][register] to the component.
