...
url: https://jurooravec.github.io/django-components/docs/getting_started/parametrising_components/
description: "So far, our Calendar component will always render the date 1970-01-01. Let's make it more useful and flexible
...
the [`get_template_data()`][Component.get_template_data] method
...
What we didn't say is that [`get_template_data()`][Component.get_template_data]
...
And so, we can write the [`get_template_data()`][Component.get_template_data]
...
The [`get_template_data()`][Component.get_template_data]
...
Without the [`get_template_data()`][Component.get_template_data] method,
we'd have to either:
...
Instead, with [`get_template_data()`][Component.get_template_data],
...
Similarly we can make use of [`get_template_data()`][Component.get_template_data]
...
or [`get_css_data()`][Component.get_css_data].
...
To define defaults for a component, you create a nested [`Defaults`][Component.Defaults] class within your
...
- [`Args`][Component.Args] - For defining positional args passed to the component
- [`Kwargs`][Component.Kwargs] - For keyword args
- [`Slots`][Component.Slots] - For slots
