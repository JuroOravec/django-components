...
- django_components now automatically configures Django to support multi-line tags. (See [Multiline tags](https://github.com/EmilStenstrom/django-components#multi-line-tags))
