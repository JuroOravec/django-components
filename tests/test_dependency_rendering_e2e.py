...
class TestE2eDependencyRendering:
    ...
    async def test_single_component_dependencies(self):
        ...
        assert (
            re.compile(
                r'Variable: <strong class="inner" data-djc-id-\w{7}="" data-djc-scope-\w{6}="">foo</strong>'
    ...
    async def test_multiple_component_dependencies(self):
        ...
        assert (
            re.compile(
                # <div class="outer" data-djc-id-c10uLMD data-djc-scope-6298a6>
                #     Variable:
                #     <strong class="inner" data-djc-id-cDZEnUC data-djc-scope-abb09b>
                #         variable
                #     </strong>
                #     XYZ:
                #     <strong class="other" data-djc-id-cIYirHK data-djc-scope-7d5e08>
                #         variable_inner
                #     </strong>
                # </div>
                # <div class="my-style">123</div>
                # <div class="my-style2">xyz</div>
                r'<div class="outer" data-djc-id-\w{7}="" data-djc-scope-\w{6}="">\s*'
                r"Variable:\s*"
                r'<strong class="inner" data-djc-id-\w{7}="" data-djc-scope-\w{6}="">\s*'
                r"variable\s*"
                r"<\/strong>\s*"
                r"XYZ:\s*"
                r'<strong class="other" data-djc-id-\w{7}="" data-djc-scope-\w{6}="">\s*'
                r"variable_inner\s*"
                r"<\/strong>\s*"
                r"<\/div>\s*"
    ...
    async def test_renders_css_nojs_env(self):
        ...
        #     </strong>
        #     XYZ:
        #     <strong data-djc-id-cIYirHK class="other" data-djc-scope-7d5e08>
        #         variable_inner
        #     </strong>
        # </div>
        # <div class="my-style">123</div>
